define(function(require, exports, module) {
    ...
    var template = [
        '<div class="ali-calendar">',
        '<div class="ali-calendar-pannel" data-role="pannel">',
        '<span class="ali-calendar-control prev-year" data-role="prev-year">&lt;&lt;</span>',
        '<span class="ali-calendar-control" data-role="prev-month">&lt;</span>',
        '<span class="ali-calendar-control year" data-role="current-year"></span>',
        '<span class="ali-calendar-control month" data-role="current-month"></span>',
        '<span class="ali-calendar-control" data-role="next-month">&gt;</span>',
        '<span class="ali-calendar-control next-year" data-role="next-year">&gt;&gt;</span>',
        '</div>',
        '<div class="ali-calendar-container" data-role="container">',
        '</div>',
        '</div>'
    ].join('');

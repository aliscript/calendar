define(function(require, exports, module) {
    ...
    /* template in handlebars
     <table class="ali-calendar-year" data-role="year-column">
     {{#each items}}
     <tr class="ali-calendar-year-column">
     {{#each this}}
    ...
    function template(model, options) {
        ...
        var html = '<table class="ali-calendar-year" data-role="year-column">';

        $.each(model.items, function(i, items) {
            html += '<tr class="ali-calendar-year-column">';

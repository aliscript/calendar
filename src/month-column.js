define(function(require, exports, module) {
  ...
  <table class="ali-calendar-month" data-role="month-column">
  {{#each items}}
  <tr class="ali-calendar-month-column">
      {{#each this}}
  ...
  */
  ...
  function template(model, options) {
    ...
    var html = '<table class="ali-calendar-month" data-role="month-column">';
    $.each(model.items, function(i, items) {
      html += '<tr class="ali-calendar-month-column" data-year="' + model.current.year + '">';
